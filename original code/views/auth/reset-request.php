...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-white to-slate-100 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full">
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
            ...
            <!-- Reset Request Form -->
            <form class="space-y-6" method="POST" action="/auth/resetRequest">
                <div>
        ...
        <div class="mt-8 text-center">
            <a href="/auth/login" class="inline-flex items-center text-sm font-semibold text-emerald-600 hover:text-emerald-500 transition-colors duration-200">
