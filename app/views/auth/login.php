    ...
    <div class="max-w-md w-full">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-600">
                ...
                <a href="<?= url('/auth/register') ?>" class="font-semibold text-emerald-600 hover:text-emerald-500 transition-colors duration-200">
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
            ...
            <form class="space-y-6" method="POST">
                ...
                <div class="flex items-center justify-end">
                    <div class="text-sm">
                        <a href="<?= url('/auth/resetRequest') ?>" class="font-semibold text-emerald-600 hover:text-emerald-500 transition-colors duration-200">
